...
import data from "@/default-content/dich-vu.json";

export default function Services() {
  const { hero, services, additionalServices, cta, requestQuoteLabel } = data;
      ...
      <section className="py-20 bg-[#111111]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-5xl md:text-7xl text-white mb-4">{additionalServices.title}</h2>
